 ...
 */
final class Version20191108091914 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__task AS SELECT id, user_id, parent_id, title, points, is_done FROM task');
        $this->addSql('DROP TABLE task');
        $this->addSql('CREATE TABLE task (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, parent_id INTEGER DEFAULT NULL, title VARCHAR(50) NOT NULL COLLATE BINARY, points INTEGER NOT NULL, is_done BOOLEAN NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, CONSTRAINT FK_527EDB25727ACA70 FOREIGN KEY (parent_id) REFERENCES task (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_527EDB25A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO task (id, user_id, parent_id, title, points, is_done) SELECT id, user_id, parent_id, title, points, is_done FROM __temp__task');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE task');
        $this->addSql('CREATE TABLE task (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, parent_id INTEGER DEFAULT NULL, user_id INTEGER NOT NULL, title VARCHAR(50) NOT NULL, points INTEGER NOT NULL, is_done BOOLEAN NOT NULL)');
